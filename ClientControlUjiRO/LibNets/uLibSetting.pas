...
begin
  ...
  with nSet do begin
    ...
    FileAmphibious  := INIFReadString(inif, c_net, 'FileAmphibious',  c_NET_APPLICATION);
    FileNaval       := INIFReadString(inif, c_net, 'FileNaval',  c_NET_APPLICATION);
