...
procedure TMainForm.kill(Sender: TObject);
begin
  Close;
  Client.Disconnect;
end;
...
begin
  ...
  Client.RegisterProcedure(CommandTes, NetRecv_CommandData, SizeOf(RecCommandTes));
...
//  ShellExecute(Handle, 'open', PWideChar(vNetSetting.Application), nil, nil, SW_SHOW) ;
end;
