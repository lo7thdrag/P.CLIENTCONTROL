...
type
  TMainForm = class(TForm)
    ...
    lvVoip: TListView;
    Label5: TLabel;
    grpVAllClient: TGroupBox;
    VKillAllButton: TButton;
    VRestartAllButton: TButton;
    VRunAllButton: TButton;
    VShutdownAllButton: TButton;
    grpVRadioButton: TGroupBox;
    RadioButton2: TRadioButton;
    RadioButton5: TRadioButton;
    grpVSingleClient1: TGroupBox;
    VRunButton: TButton;
    VKillButton: TButton;
    VRestartButton: TButton;
    VShutdownButton: TButton;
...
{$ENDREGION}
    ...
    procedure VSingleButtonClick(Sender: TObject);
    procedure VAllButtonClick(Sender: TObject);
...
begin
  ShellExecute(handle, 'open', PChar('cmd.exe'), PChar('/C shutdown /r /t 2'),
    nil, SW_HIDE);
end;

procedure TMainForm.ShutdownServerButtonClick(Sender: TObject);
begin
  ShellExecute(handle, 'open', PChar('cmd.exe'), PChar('/C shutdown /s /t 2'),
    nil, SW_HIDE);
end;
...
begin
  ...
  begin
    ...
    case TButton(Sender).Tag of
      0:
        LogMemo.Lines.Add('Shutdown ' + ipaddress);
      1:
        LogMemo.Lines.Add('Restart ' + ipaddress);
      2:
        LogMemo.Lines.Add('Run ' + ipaddress);
      3:
        LogMemo.Lines.Add('Kill ' + ipaddress);
    end;
  end;
end;
...
procedure TMainForm.cbbMenuChange(Sender: TObject);
begin
  if cbbMenu.ItemIndex = 0 then
    pnlSystem.BringToFront
  else
    pnlVoip.BringToFront;
...
procedure TMainForm.VAllButtonClick(Sender: TObject);
var
  i: Integer;
  CommandData: RecCommandData;
  ipaddress: string;
...
procedure TMainForm.VSingleButtonClick(Sender: TObject);
var
  li: TListItem;
  ipaddress: string;
  CommandData: RecCommandData;
