...
begin
  ...
  with nSet do begin
    ...
    RemoteServerName  := INIFReadString(inif, c_net, 'remoteserverapp',  c_NET_APPLICATION2);
    RemoteClientName  := INIFReadString(inif, c_net, 'remoteclientapp',  c_NET_APPLICATION2);
    RemotePort        := INIFReadInteger(inif, c_net, 'remoteport',  9000);
    RemoteScreen      := INIFReadInteger(inif, c_net, 'remotescreen',  0);
  end;
